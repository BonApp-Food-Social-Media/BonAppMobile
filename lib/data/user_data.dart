...
//TODO Potentially remove the const argument to test if i can log in using more users and then change their liked meals...
const List<User> userData = [
  ...
  User(
    ...
    followingUsername: ["asdf", "fdsa", "qwer", "rewq", "yxcv", "vcxy",],
    followersUsername: ["asdf", "fdsa", "qwer", "rewq", "yxcv", "vcxy",],
  ),
];